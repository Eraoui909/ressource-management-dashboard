...
export const addAdministrative = async (administrative) =>{
  await axios.post(ADMINISTRATIVE_API_URL+"/administrative/add",administrative).then(
    (response)=>{
      return response;
    }
  ).catch(
...
export const updateAdministrative = async (administrative) =>{
  await axios.post(ADMINISTRATIVE_API_URL+"/administrative/update",administrative).then(
    (response)=>{
      return response;
    }
  ).catch(
