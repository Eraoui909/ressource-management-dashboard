...
import { getDepartments, addNewDepartment,updateDepartment,getDepartment,DeleteDepartmentService } from '../../services/DepartmentsService';
...
const Teachers = () => {
  ...
  const handleAddTeacher = () =>{
    ...
    (chef_dep_email.trim() === "")?setChef_dep_nameEmailERROR("chef department email field is required"):setChef_dep_nameEmailERROR("");
  ...
  return (<>
    ...
    <CButton color="info"  onClick={() => setVisibleLg(!visibleLg)} style={styles.ha_btn_font}>Add Department</CButton>
            ...
            return (
              <CTableRow key={index}>
                ...
                <CTableDataCell>
                    ...
                    {/*  */}
                    <CButton color="warning" style={styles.ha_btn_font} value={t.id} onClick={(e)=> deleteDepartment(e.target.value)} >Delete</CButton>
                </CTableDataCell>
            </CTableRow>
            )
          })
    ...
    <CModal size="lg" visible={visibleUpdate} onClose={() => setVisibleUpdate(false)}>
      ...
      <CForm>
        ...
        <div className="mb-3">
          ...
          <CFormInput type="text" id="exampleFormControlInput1"
            value={chef_dep_name}
            onChange={(e)=>{ setChef_dep_name(e.target.value)}}
          />
        </div>
        <div className="mb-3">
          ...
          <CFormInput type="email" id="exampleFormControlInput1"
            ...
            onChange={(e)=>{ setChef_dep_email(e.target.value)}}
          />
        </div>
