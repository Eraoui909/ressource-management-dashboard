...
const Profile = () => {
  ...
  return (<>
    ...
    <div className='row'>
      <div className='col-8' style={{backgroundColor:"#fff",padding:"15px", borderRight: "6px solid #ebedef"}}>
        <CCardHeader style={{backgroundColor:"#fff", marginBottom:"20px"}}><h5>Profile Settings</h5></CCardHeader>
        { nameERROR &&
        ...
        <div className='col-4' style={{backgroundColor:"#fff",padding:"0", height: "fit-content"}}>
        <CCard style={{ width: '100%' }}>
            <CCardImage orientation="top" src={back} />
            <CCardBody style={{display: "flex", flexWrap: "wrap", justifyContent: "center", padding: "0"}}>
                <img src={avatar} alt="" style={{borderRadius: "50%", border: "3px solid rgb(75 141 161)", marginTop: "-75px"}}/>
